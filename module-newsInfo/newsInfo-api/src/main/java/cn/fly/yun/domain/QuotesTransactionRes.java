...
public class QuotesTransactionRes extends BaseRes {
    ...
    public String toString() {
        return "QuotesTransactionRes{" +
                "id=" + id +
                ", priceNow='" + priceNow + '\'' +
                ", increasePercentage='" + increasePercentage + '\'' +
                ", high='" + high + '\'' +
                ", low='" + low + '\'' +
                ", priceDoller='" + priceDoller + '\'' +
                ", priceBtc='" + priceBtc + '\'' +
                ", marketValue='" + marketValue + '\'' +
                ", marketValueDoller='" + marketValueDoller + '\'' +
                ", marketValueBtc='" + marketValueBtc + '\'' +
                ", marketValueRate='" + marketValueRate + '\'' +
                ...
                ", turnoverDoller='" + turnoverDoller + '\'' +
                ", turnoverBtc='" + turnoverBtc + '\'' +
